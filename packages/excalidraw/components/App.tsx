...
import { buildStoryboardElements, parseSRT } from "../data/storyboard";
...
class App extends React.Component<AppProps, AppState> {
  ...
  private addTextFromPaste(text: string, isPlainPaste = false) {
    const storyboardScenes = parseSRT(text);
    if (storyboardScenes) {
      const storyboardElements = buildStoryboardElements(storyboardScenes, {
        ...
        currentItemFontFamily: this.state.currentItemFontFamily,
        currentItemFontSize: this.state.currentItemFontSize,
      });
      if (storyboardElements.length) {
        this.addElementsFromPasteOrLibrary({
