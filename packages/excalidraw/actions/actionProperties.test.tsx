...
describe("element locking", () => {
  ...
  describe("properties when elements selected", () => {
    ...
    it("should highlight common stroke width of selected elements", () => {
      ...
      expect(strokeWidthSlider).not.toBeNull();
      expect(strokeWidthSlider!.value).toBe(String(STROKE_WIDTH.thin));
    });

    it("should not highlight any stroke width button if no common style", () => {
      API.setAppState({ currentItemStrokeWidth: 5 });
      ...
      expect(strokeWidthSlider).not.toBeNull();
      expect(strokeWidthSlider!.value).toBe("5");
    });
    ...
    it("should show properties of different element types when selected", () => {
      ...
      expect(strokeWidthSlider).not.toBeNull();
      expect(strokeWidthSlider!.value).toBe(String(STROKE_WIDTH.bold));
