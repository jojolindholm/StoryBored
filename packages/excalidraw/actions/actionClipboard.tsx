...
export const actionCopy = register({
  ...
  perform: async (elements, appState, event: ClipboardEvent | null, app) => {
    ...
    let clipboardSvg: string | null = null;
    if (elementsToCopy.length) {
      try {
        ...
        if (exportedElements.length) {
          ...
          clipboardSvg = svgElement.outerHTML;
        }
      } catch (error: any) {
        console.error("Unable to prepare SVG clipboard payload", error);
      }
    }
